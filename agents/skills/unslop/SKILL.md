---
name: unslop
description: Edit prose to remove common AI writing patterns while preserving meaning and intended tone. Use when proofreading, rewriting, or polishing text.
license: MIT
metadata:
  author: Lauren Tan
---
...
Rule numbers are stable identifiers. If you remove a rule, leave its number unused.
...
13. **Em dash overuse.** Avoid em dashes. Use periods or commas. If a thought needs separation, end the sentence or use a comma. Use a plain dash when the user or project style requires it.
