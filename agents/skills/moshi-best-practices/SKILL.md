...
description: Set up or verify a Moshi remote coding host (Mosh/SSH, tmux, agent hooks)
---
...
- setting up SSH or (preferably) Mosh readiness on a host
- diagnosing non-interactive shell PATH issues
- applying tmux defaults
- creating a tmux project session rooted at a chosen directory
- installing Moshi agent hooks for supported coding-agent CLIs
- offering the optional `moshi DIR` shell helper
